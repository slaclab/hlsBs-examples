...
#-----------------------------------------------------------------------------
# Description:
# ex4: sweep a #define value (Product.Values), producing four components.
#-----------------------------------------------------------------------------
...
def get_products(project):
    ...
    # --------------------------------------------------------------------------
    # The component is constructed for the build, the #define values, and FPGAs.
    ...
    # from each of the component classes, here Builds, Values, Fpgas.
    # The exception is if the class has only 1 member.
    #
    #  e.g.  build/stream-seed10-6ns.cfg
    #
    # Here is an example where adding some text helps add meaning.
    # -----------------------------------------------------------------------
